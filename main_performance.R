...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Datasets/Github')
git_ds <- list()
...
# Gaussian datasets
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/1_number_clusters_gaussian')
...
for(i in 1:length(gauss_ds)){
  n[i] <- dim(gauss_ds[[i]])[2]
  t1 <- Sys.time()
  v <- inaparc::kmpp(gauss_ds[[i]][, -(n[i]:n[i])], k = nc_kmeans[[i]])$v
  u <- inaparc::imembrand(nrow(gauss_ds[[i]][, -(n[i]:n[i])]), k = nc_kmeans[[i]])$u
  clusters <- fcm(as.matrix(gauss_ds[[i]][, -(n[i]:n[i])]), centers = v, memberships = u, m = 2)
...
# ellipsoidal datasets
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/2_number_clusters_ellipsoidal')
...
for(i in 1:length(ellips_ds)){
  n[i] <- dim(ellips_ds[[i]])[2]
  t1 <- Sys.time()
  v <- inaparc::kmpp(ellips_ds[[i]][, -(n[i]:n[i])], k = nc_kmeans2[[i]])$v
  u <- inaparc::imembrand(nrow(ellips_ds[[i]][, -(n[i]:n[i])]), k = nc_kmeans2[[i]])$u
  clusters <- fcm(as.matrix(ellips_ds[[i]][, -(n[i]:n[i])]), centers = v, memberships = u, m = 2)
...
# small datasets
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/3_number_clusters_small')
...
for(i in 1:length(small_ds)){
  n[i] <- dim(small_ds[[i]])[2]
  t1 <- Sys.time()
  v <- inaparc::kmpp(small_ds[[i]][, -(n[i]:n[i])], k = nc_kmeans3[[i]])$v
  u <- inaparc::imembrand(nrow(small_ds[[i]][, -(n[i]:n[i])]), k = nc_kmeans3[[i]])$u
  clusters <- fcm(as.matrix(small_ds[[i]][, -(n[i]:n[i])]), centers = v, memberships = u, m = 2)
...
# medium datasets
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/4_number_clusters_medium')
...
for(i in 1:length(medium_ds)){
  n[i] <- dim(medium_ds[[i]])[2]
  t1 <- Sys.time()
  v <- inaparc::kmpp(medium_ds[[i]][, -(n[i]:n[i])], k = nc_kmeans4[[i]])$v
  u <- inaparc::imembrand(nrow(medium_ds[[i]][, -(n[i]:n[i])]), k = nc_kmeans4[[i]])$u
  clusters <- fcm(as.matrix(medium_ds[[i]][, -(n[i]:n[i])]), centers = v, memberships = u, m = 2)
...
# large datasets
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/5_number_clusters_large')
...
for(i in 1:length(large_ds)){
  n[i] <- dim(large_ds[[i]])[2]
  t1 <- Sys.time()
  v <- inaparc::kmpp(large_ds[[i]][, -(n[i]:n[i])], k = nc_kmeans5[[i]])$v
  u <- inaparc::imembrand(nrow(large_ds[[i]][, -(n[i]:n[i])]), k = nc_kmeans5[[i]])$u
  clusters <- fcm(as.matrix(large_ds[[i]][, -(n[i]:n[i])]), centers = v, memberships = u, m = 2)
...
# github datasets
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/6_number_clusters_github')
...
for(i in 1:length(git_ds)){
  ...
  n[i] <- dim(git_ds[[i]])[2]
  t1 <- Sys.time()
  #v <- inaparc::kmpp(git_ds[[i]][, -(n[i]:n[i])], k = nc_kmeans6[[i]])$v
  #u <- inaparc::imembrand(nrow(git_ds[[i]][, -(n[i]:n[i])]), k = nc_kmeans6[[i]])$u
  #clusters <- fcm(as.matrix(git_ds[[i]][, -(n[i]:n[i])]), centers = v, memberships = u, m = 2)
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Datasets/Gaussian')
gauss_ds <- list()
names1 = list.files(pattern="*.dat")
for(i in 1:length(names1)){
  gauss_ds[[i]] <- fread(names1[i])
...
# Importing ellipsoidal datasets (80 datasets)
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Datasets/Ellipsoidal')
ellips_ds <- list()
names2 = list.files(pattern="*.dat")
for(i in 1:length(names2)){
  ellips_ds[[i]] <- fread(names2[i])
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/2_number_clusters_ellipsoidal')
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Datasets/CSV/Small')
small_ds <- list()
names3 = list.files(pattern="*.csv")
for(i in 1:length(names3)){
  small_ds[[i]] <- fread(names3[i], colClasses =  'double') # converṣo de tipo para ṇo ler tudo como 'integer'
}

setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/3_number_clusters_small')
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Datasets/CSV/Medium')
medium_ds <- list()
names4 = list.files(pattern="*.csv")
for(i in 1:length(names4)){
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/4_number_clusters_medium')
...
for(i in 1:length(medium_ds)){
  ...
  #kmedoids_medium_rl[i] <- rl$ratkowsky_lance
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Datasets/CSV/Large')
large_ds <- list()
names5 = list.files(pattern="*.csv")
for(i in 1:length(names5)){
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/5_number_clusters_large')
...
require(data.table)
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes')
metadata2 <- fread('metadata2.csv')
metadata <- metadata2[1:160, 1:16]

# k-means
metadata_bh <- metadata
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Internal indexes - gaussian datasets')
kmeans_gaussian_bh <- readRDS('kmeans_gaussian_bh.Rds')
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Internal indexes - ellipsoidal datasets')
...
# k-means
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/8_internal_indexes_small')
kmeans_small_bh <- readRDS('kmeans_small_bh.Rds')
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/9_internal_indexes_medium')
kmeans_medium_bh <- readRDS('kmeans_medium_bh.Rds')
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/10_internal_indexes_large')
...
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Metadata_small_medium_large')
...
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Metadata_gauss_ellips')
metadata_bh <- fread('metadata_bh.csv')
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Metadata_small_medium_large')
metadata_bh2 <- fread('metadata_bh2.csv')
metadata_bh_full <- rbind(metadata_bh, metadata_bh2)
setwd('C:/Users/Luiz Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Metadata_full')
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Metadata_github')
metadata <- fread('metafeatures_all.csv')

setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Metadata_full')
metadata_ch_ant <- fread('metadata_ch_full.csv')
alg_ch_ant <- metadata_ch_ant[, 17:26]

setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/6_internal_indexes_github')
...
setwd('C:/Users/Luiz_Henrique/Desktop/Luiz Henrique/Doutorado/Pesquisas de Tese/R/Clustering/Instance Space - Internal Indexes/Metadata_hub_stability')
